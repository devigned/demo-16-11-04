...
public final class ManageVirtualMachine {
    ...
    public static void main(String[] args) {
        ...
        final String rgName = "javaFluentDemo";
        ...
        try {
            ...
            String path = System.getenv("AZURE_AUTH_LOCATION").replaceFirst("^~",System.getProperty("user.home"));
            final File credFile = new File(path);
